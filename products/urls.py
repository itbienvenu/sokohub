...
urlpatterns = [
    ...
    path('vendor/products/<int:pk>/reviews/', views.vendor_product_reviews, name='vendor_product_reviews'),
    path('vendor/reviews/reply/<int:pk>/', views.vendor_reply_review, name='vendor_reply_review'),
